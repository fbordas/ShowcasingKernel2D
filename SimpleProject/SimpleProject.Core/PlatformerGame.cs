...
namespace PlatformerGameProject.Core
{
    ...
    public class PlatformerGame : Game
    {
        ...
        protected override void Initialize()
        {
            ...
            _input.RegisterButtonMapping("jump", [Buttons.A]);
            _input.RegisterButtonMapping("move_left", [Buttons.DPadLeft]);
            _input.RegisterButtonMapping("move_right", [Buttons.DPadRight]);
