...
//using PlatformerGameProject.Core.Screens;
//using PlatformerInputBridge = MonoGame.Kernel2D.Input.PlatformerInputBridge;
////using PPC = PlatformerGameProject.Core.GameEntities.PlatformerPlayerCharacter;
...
//    /// </summary>
//    public class PlatformerGame_OLD : Game
//    {
...
//            //player = new(new XVector(150, 400), sb, sheet, playerTexture, _font);
//        }
...
//        private ScreenManager _manager = null;// => ScreenManager.Instance;
